...
public class CelsiusConverterGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        convertButton.setToolTipText("Convert to Fahrenheit");
    ...
    private void convertButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_convertButtonActionPerformed
        int tempFehr = (int) ((Double.parseDouble(tempTextField.getText())) * 1.8 + 32);
        fahrenheitLabel.setText(tempFehr + " Fahrenheit");
